            ...
            if not movies:
                ...
                if movie_delete is None:
                    ...
                    if not delete_another:
                        # User doesn't want to delete another movie, break out of loop.
                        break
    ...
    if choice == "View existing movie":
        while True:
            ...
            if not movies:
                ...
                cursor.execute("SELECT * FROM Movie WHERE title=?", (movie_title,))
        ...
        while True:
            ...
            if not movies:
                ...
                if movie_edit is None:
                    ...
                    if not edit_another:
                        # User doesn't want to edit another movie, break out of loop.
                        break
    # Exit functionality.    
    if choice == "Exit":
        # Exit the program.
